...
public class ManhuntConfig implements ConfigData {
    ...
    @Gui.Tooltip(count = 3)
    public ManhuntConfigEnums.Compass compassBehaviour = ManhuntConfigEnums.Compass.USE;
    ...
    @Gui.Tooltip(count = 3)
    public ManhuntConfigEnums.Damage damageBehaviour = ManhuntConfigEnums.Damage.KILL;
